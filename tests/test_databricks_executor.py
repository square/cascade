...
from block.cascade import DatabricksResource
from block.cascade.executors import DatabricksExecutor
...
# Mocks paths
MOCK_CLUSTER_POLICY = (
    "block.cascade.executors.DatabricksExecutor.get_cluster_policy_id_from_policy_name"
)
