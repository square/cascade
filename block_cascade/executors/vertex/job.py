...
from block.cascade.executors.vertex.resource import GcpMachineConfig, GcpResource
...
class VertexJob:
    ...
    resource: GcpResource
        ...
        see block.cascade.executors.vertex.resource for details
    storage_path: str
    ...
    def _create_container_spec(self):
        ...
        executor_module_path = "block.cascade.executors.vertex.run"
